package com.example.tagsmassive

import android.annotation.SuppressLint
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.tagsmassive.databinding.ItemTagsBinding
...
class AdapterTags(val onItemClick: (tags: String) -> Unit)
    ...
    inner class ViewHolder(private var binding: ItemTagsBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(tag: String) {
